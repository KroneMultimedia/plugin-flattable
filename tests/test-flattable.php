...
class TestFlattable extends WP_UnitTestCase
{
    ...
    public function save_enabled_post_insert_update()
    {
        ...
        $mock->expects($this->exactly(4))
            ->method('query')
            ->withConsecutive(['ALTER TABLE wptestflattable_article ADD `post_id` bigint(20)'], ['ALTER TABLE wptestflattable_article ADD `post_type` varchar(100)'], ['ALTER TABLE wptestflattable_article ADD `x` int(1)']);
